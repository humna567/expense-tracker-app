...
<body style="background-image: url('images/bgimg.webp'); background-repeat: no-repeat; background-size: cover;">
          ...
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="img img-fluid rounded-circle" src="<?php echo $userprofile ?>" width="50">
              </a>
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col text-center">
                    <a href="reports.php"><img src="images/img1.1.jpg" width="57px" style="border-radius: 50%;"  />
                      <p>Expense Report</p>
                    </a>
                  </div>
                  <div class="col text-center">
