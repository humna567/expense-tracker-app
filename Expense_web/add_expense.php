...
if (isset($_POST['add'])) {
    ...
    $expenses = "INSERT INTO expenses (user_id, expense, expensedate, expensecategory, Payment_Type) VALUES ('$userid', '$expenseamount', '$expensedate', '$expensecategory', '$paymenttype')";
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE expenses SET expense='$expenseamount', expensedate='$expensedate', expensecategory='$expensecategory', Payment_Type='$paymenttype' WHERE user_id='$userid' AND expense_id='$id'";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="reports.php" class="list-group-item list-group-item-action"><span data-feather="file-text"></span> Expenses Report</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <select class="form-control col-sm-12" name="paymenttype" id="paymenttype" required>
                        <option value="Cash" <?php echo ($paymenttype == 'Cash') ? 'selected' : ''; ?>>Cash</option>
                        <option value="Credit Card" <?php echo ($paymenttype == 'Credit Card') ? 'selected' : ''; ?>>Credit Card</option>
                        <option value="Debit Card" <?php echo ($paymenttype == 'Debit Card') ? 'selected' : ''; ?>>Debit Card</option>
                        <option value="Online Payment" <?php echo ($paymenttype == 'Online Payment') ? 'selected' : ''; ?>>Online Payment</option>
                    </select>
                </div>
            </div>
